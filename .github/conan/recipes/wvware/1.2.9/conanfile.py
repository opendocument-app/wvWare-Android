...
class wvWareConan(ConanFile):
    ...
    description = "Library to load and parse Word 2000, 97, 95 and 6 files"
    ...
    def source(self):
        ...
        Path(os.path.join(self.source_folder, 'AUTHORS')).touch()
        Path(os.path.join(self.source_folder, 'ChangeLog')).touch()
